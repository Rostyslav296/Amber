...
TOOL_METADATA = {
    "name": "fterminal",
    "description": "Opens FTerminal (a custom PySide6 GUI terminal — NOT the native macOS Terminal.app). "
                   "Only use this for running scripts in the tools directory. "
                   "For native macOS Terminal.app, use 'macos_terminal' instead.\n"

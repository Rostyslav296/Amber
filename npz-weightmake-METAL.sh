...
# ==============================================================
# npz-weightmake.sh — Create manifest qwen.npz for Qwen3.5-9B-MLX-4bit
# ==============================================================

# --- Config / defaults ---
LLM_DIR="${LLM_DIR:-$HOME/Developer/llm}"
REPO="${1:-mlx-community/Qwen3.5-9B-MLX-4bit}"  # default HF repo (MLX-optimized 9B)
...
repo   = os.environ.get("REPO", "mlx-community/Qwen3.5-9B-MLX-4bit")
...
echo
echo "✅ Done. Your manifest qwen.npz points to Qwen3.5-9B-MLX-4bit."
